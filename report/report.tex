...
The study of argumentation in legal contexts has its roots in logic, philosophy, and linguistics, as it studies how different claims and opinions are proposed, debated, and evaluated, considering their relations and inter-dependencies.
The legal domain offers a natural scenario for the application of different argument models as well as novel machine learning and natural language processing techniques in order to perform legal reasoning.
Existing literature has already evaluated multiple models and variants on english language Datasets like Demosthenes \cite{grundler-etal-2022-detecting}.

An italian language dataset suitable to work on legal argument mining has been recently developed \cite{galli2022}.
...
Class imbalance \cite{henning-etal-2023-survey}

GE3 \cite{wei-2021-good}

Focal loss \cite{lin2018focallossdenseobject}

\cite{LICARI2024105908}
